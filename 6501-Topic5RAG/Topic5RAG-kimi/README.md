...
> Generated by `code-puppy-clone-2-26cae9` (PiercePuppy). Because we like tidy repos.
...
| File | Description |
|------|-------------|
| [kimi_exercise_0_setup.txt](./kimi_exercise_0_setup.txt) | Environment setup, corpus loading, index building |
| [kimi_exercise_1_rag_vs_norag.txt](./kimi_exercise_1_rag_vs_norag.txt) | RAG vs direct query comparison |
| [kimi_exercise_2_gpt4o_mini_comparison.txt](./kimi_exercise_2_gpt4o_mini_comparison.txt) | GPT-4o Mini comparison |
| [kimi_exercise_3_frontier_comparison.txt](./kimi_exercise_3_frontier_comparison.txt) | Frontier model comparison (manual) |
| [kimi_exercise_4_topk_effect.txt](./kimi_exercise_4_topk_effect.txt) | Effect of top-k retrieval count |
| [kimi_exercise_5_unanswerable.txt](./kimi_exercise_5_unanswerable.txt) | Handling unanswerable questions |
| [kimi_exercise_6_phrasing_sensitivity.txt](./kimi_exercise_6_phrasing_sensitivity.txt) | Query phrasing sensitivity |
| [kimi_exercise_7_chunk_overlap.txt](./kimi_exercise_7_chunk_overlap.txt) | Chunk overlap experiment |
| [kimi_exercise_8_chunk_size.txt](./kimi_exercise_8_chunk_size.txt) | Chunk size experiment |
| [kimi_exercise_9_score_analysis.txt](./kimi_exercise_9_score_analysis.txt) | Retrieval score analysis |
| [kimi_exercise_10_prompt_templates.txt](./kimi_exercise_10_prompt_templates.txt) | Prompt template variations |
| [kimi_exercise_11_failure_modes.txt](./kimi_exercise_11_failure_modes.txt) | Failure mode catalog |
| [kimi_exercise_12_cross_document.txt](./kimi_exercise_12_cross_document.txt) | Cross-document synthesis |
